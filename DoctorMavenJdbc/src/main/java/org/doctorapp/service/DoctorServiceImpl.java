...
public class DoctorServiceImpl implements IDoctorService {
    ...
    @Override
    public List<Doctor> getAll(String speciality) {
        return null;
    }
    ...
    public List<Doctor> getBySpeciality(String speciality)throws DoctorNotFoundException {
        ...
        Collections.sort(doctors,(d1,d2)->((Integer)(d2.getExperince())).compareTo(d2.getExperince()));
        return doctors;
    ...
    public List<Doctor> getBySpecialityAndRating(String speciality, int ratings)throws DoctorNotFoundException {
        ...
        if(doctors.isEmpty())
            throw new DoctorNotFoundException("doctor by this specility and exprience is not found");
        Collections.sort(doctors,(d1,d2)->((Integer)(d2.getRating())).compareTo(d2.getRating()));
        return doctors;
    ...
    public List<Doctor> getBySpecialityAndNameContains(String speciality, String doctorName)throws DoctorNotFoundException {
        ...
        if(doctors.isEmpty())
            throw new DoctorNotFoundException("doctor by this specility and name is not found");
        Collections.sort(doctors,(d1,d2)->((Integer)(d2.getExperince())).compareTo(d2.getExperince()));
        return doctors;
